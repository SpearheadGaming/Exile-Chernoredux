...
salvageVehicle_REQUIRE_TOOLS_CAR		= ["Exile_Item_Grinder"];
...
salvageVehicle_REQUIRE_TOOLS_TANK		= ["Exile_Item_Grinder"];
...
salvageVehicle_REQUIRE_TOOLS_AIR		= ["Exile_Item_Grinder"];
...
salvageVehicle_REQUIRE_TOOLS_SHIP		= ["Exile_Item_Grinder"];
...
salvageVehicle_givenJunkTank			= [["Exile_Item_JunkMetal", 6],["Exile_Item_MetalPole", 3],["Exile_Item_MetalBoard", 10]];

// Set the Junk returned to the player for salvaging an Aircraft only.
salvageVehicle_givenJunkAir				= [["Exile_Item_JunkMetal", 4],["Exile_Item_MetalPole", 3],["Exile_Item_MetalBoard", 5]];
